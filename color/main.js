class Game {
    ...
    * Display score
     ...
     */
    showGrade(score) {
    if(score > 30) return "Çak Norris?";
else if(score > 25) return "Əhsən";
else if(score > 20) return "Möhtəşəm";
else if(score > 15) return "Əla!";
else if(score > 13) return "Yaxşı!";
else if(score > 10) return "Yaxşı iş!";
else if(score > 5) return "Ciddisən?";
else return "Zəif...";
